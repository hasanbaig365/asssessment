...
let absentGuestIndex: number = 1;  // Assuming Marie Curie can't make it
...
let absentGuestIndex1: number = 1;  // Assuming Marie Curie can't make it
...
let absentGuestIndex2: number = 1;  // Assuming Marie Curie can't make it
...
let usernames1: string[] = []; // Empty array of usernames
